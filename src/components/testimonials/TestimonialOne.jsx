...
const testimonialImg = "/home_1/testimonial_img.png";
...
const testimonials = [
  {
    name: "Priya Sharma",
    role: "Classical Vocal Student",
    avatar: avatar1,
    rating: 5,
    text: "Madhushala Music has been a life-changing experience for me. The classical vocal training I received here helped me discover my true voice. The instructors are highly skilled and patient, making every lesson enjoyable and enriching."
  },
  {
    name: "Rajesh Thapa",
    role: "Guitar Student",
    avatar: avatar2,
    rating: 5,
    text: "Learning guitar at Madhushala was the best decision I made. The personalized attention and structured curriculum helped me progress from a complete beginner to performing confidently. The facilities and teaching methods are world-class."
  },
  {
    name: "Sangita Karki",
    role: "Kathak Dance Student",
    avatar: avatar1,
    rating: 4.5,
    text: "The Kathak classes at Madhushala are exceptional. My instructor's dedication and the supportive environment helped me master complex dance forms. I've performed at several cultural events thanks to the confidence I gained here."
  },
  {
    name: "Anil Gurung",
    role: "Tabla Student",
    avatar: avatar2,
    rating: 5,
    text: "As a tabla student, I appreciate the traditional teaching methods combined with modern techniques at Madhushala. The rhythmic training and practice sessions have made me a much better percussionist. Highly recommended!"
  },
  {
    name: "Maya Rai",
    role: "Piano Student",
    avatar: avatar1,
    rating: 5,
    text: "Madhushala Music School provided me with excellent piano training. The teachers are not just skilled musicians but also wonderful mentors. The regular recitals and concerts gave me invaluable performance experience."
  }
];
      ...
      <div className="container">
        ...
        >
          ...
          <p className="td_section_subtitle td_fs_18 mb-0 td_white_color td_opacity_7">
            Hear from our talented students about their musical journey
            <br />
            at Madhushala Music School
          </p>
        </div>
                ...
                <div className="td_slider_wrapper">
                  <SlickSlider {...settings}>
                    {testimonials.map((testimonial, idx) => (
                      <div key={idx} className="td_slide">
                        <div className="td_testimonial td_style_1 td_white_bg td_radius_5">
                          ...
                          <div className="td_rating" data-rating={testimonial.rating}>
