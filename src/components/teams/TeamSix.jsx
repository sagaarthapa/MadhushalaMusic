...
const teamMember1 = "/home_7/team_member_1.jpg";
const teamMember2 = "/home_7/team_member_2.jpg";
const teamMember3 = "/home_7/team_member_3.jpg";
const teamMember4 = "/home_7/team_member_4.jpg";
                ...
                <div className="td_team_info">
                  <div className="td_team_info_in">
                    <h3 className="td_team_member_title td_fs_20 mb-0">
                      <Link href="/team-members/t-123">{member.name}</Link>
                    </h3>
