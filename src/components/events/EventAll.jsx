...
const event1 = "/home_1/event_thumb_1.jpg";
const event5 = "/home_1/event_thumb_5.jpg";
const event8 = "/home_1/event_thumb_8.jpg";
...
const Item = ({ src, location, date, time, title, description }) => {
  return (
    <div className="td_card td_style_1 td_radius_5">
      <Link href="/event/ev-123" className="td_card_thumb td_mb_30 d-block">
      ...
      <div className="td_card_info">
        <div className="td_card_info_in">
          ...
          <h2 className="td_card_title td_fs_32 td_semibold td_mb_20">
            <Link href="/event/ev-123">{title}</Link>
          </h2>
