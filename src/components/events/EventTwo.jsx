...
const eventThumb1 = "/home_2/event_thumb_1.jpg";
const eventThumb2 = "/home_2/event_thumb_2.jpg";
const eventThumb3 = "/home_2/event_thumb_3.jpg";
          ...
          {events.map((event, idx) => (
            ...
            >
              <div className="td_card td_style_1 td_type_2 td_white_bg">
                <Link href="/event/ev-123" className="td_card_thumb d-block">
                ...
                <div className="td_card_info">
                  <div className="td_card_info_in">
                    ...
                    <h2 className="td_card_title td_fs_32 td_semibold td_mb_25">
                      <Link href="/event/ev-123">{event.title}</Link>
                    </h2>
